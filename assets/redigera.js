...
(function () {
  ...
  function buildCleanHtml() {
    ...
    clone.querySelectorAll('#mk-editbar, .mk-rowbtn, .mk-addrow, #mk-rnav, #mk-fab, #mk-top, #mk-qty, #mk-komp, ' +
      ...
      '.mk-saknas, .mk-prodlank, .mk-ingsub, #mk-byt-notis, .mk-ingsok, .mk-bytsmak, .mk-smakval, #mk-kedja, #mk-kommentarer, #mk-komm-pill, ' +
      '#mk-verif-badge, #mk-verif-info, #mk-verif-bg').forEach(function (el) { el.remove(); });
